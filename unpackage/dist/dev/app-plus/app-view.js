...
var c8=_mz(z,'view',['class',2,'hidden',1],[],e,s,gg)
var h9=_mz(z,'view',['class',4,'style',1],[],e,s,gg)
_(c8,h9)
_(f7,c8)
}
else{f7.wxVkey=2
...
var oBB=_mz(z,'view',['class',9,'style',1],[],e,s,gg)
_(cAB,oBB)
var lCB=_mz(z,'view',['class',11,'style',1],[],e,s,gg)
_(cAB,lCB)
var aDB=_mz(z,'view',['class',13,'style',1],[],e,s,gg)
_(cAB,aDB)
var tEB=_mz(z,'view',['class',15,'style',1],[],e,s,gg)
_(cAB,tEB)
_(o0,cAB)
var eFB=_n('view')
...
_(eFB,oHB)
var xIB=_mz(z,'view',['class',22,'style',1],[],e,s,gg)
_(eFB,xIB)
...
var cLB=_mz(z,'view',['class',27,'style',1],[],e,s,gg)
_(fKB,cLB)
var hMB=_mz(z,'view',['class',29,'style',1],[],e,s,gg)
_(fKB,hMB)
var oNB=_mz(z,'view',['class',31,'style',1],[],e,s,gg)
_(fKB,oNB)
var cOB=_mz(z,'view',['class',33,'style',1],[],e,s,gg)
_(fKB,cOB)
_(o0,fKB)
_(f7,o0)
}
var oPB=_mz(z,'text',['class',35,'style',1],[],e,s,gg)
...
var xWB=_mz(z,'view',['catchtap',8,'class',1,'data-event-opts',2],[],e,s,gg)
var oXB=_n('slot')
_(xWB,oXB)
_(oVB,xWB)
_(eTB,oVB)
...
var h1B=_mz(z,'post-list-card',['bind:__l',1,'class',1,'vueId',2],[],e,s,gg)
_(cZB,h1B)
_(r,cZB)
return r
}
...
_(hEC,oFC)
_(cDC,hEC)
var cGC=_mz(z,'input',['focus',-1,'bindinput',12,'class',1,'data-event-opts',2,'placeholder',3,'value',4],[],e,s,gg)
_(cDC,cGC)
_(fCC,cDC)
var oHC=_n('view')
...
_(lIC,aJC)
_(oHC,lIC)
var tKC=_mz(z,'input',['password',-1,'bindinput',20,'class',1,'data-event-opts',2,'placeholder',3,'value',4],[],e,s,gg)
_(oHC,tKC)
_(fCC,oHC)
var eLC=_n('view')
_rz(z,eLC,'class',25,e,s,gg)
var bMC=_mz(z,'button',['bindtap',26,'class',1,'data-event-opts',2],[],e,s,gg)
...
var oVC=_mz(z,'image',['class',5,'mode',1,'src',2],[],e,s,gg)
_(cUC,oVC)
var lWC=_n('view')
...
_(cUC,lWC)
_(oTC,cUC)
var h7C=_mz(z,'view',['bindtap',18,'class',1,'data-event-opts',2],[],e,s,gg)
_(oTC,h7C)
_(hSC,oTC)
var o8C=_n('view')
...
var bED=_n('view')
_rz(z,bED,'class',28,e,s,gg)
var oFD=_oz(z,29,e,s,gg)
_(bED,oFD)
_(eDD,bED)
var xGD=_n('view')
_rz(z,xGD,'class',30,e,s,gg)
...
_(o8C,oND)
_(hSC,o8C)
var bSD=_mz(z,'view',['bindtap',42,'class',1,'data-event-opts',2],[],e,s,gg)
var oTD=_v()
_(bSD,oTD)
...
_(fWD,cXD)
_(oVD,fWD)
var hYD=_mz(z,'label',['class',49,'style',1],[],e,s,gg)
...
var xUD=_v()
_(bSD,xUD)
if(_oz(z,54,e,s,gg)){xUD.wxVkey=1
var l3D=_n('view')
_rz(z,l3D,'class',55,e,s,gg)
var a4D=_oz(z,56,e,s,gg)
_(l3D,a4D)
_(xUD,l3D)
}
oTD.wxXCkey=1
...
_(fQC,hSC)
var t5D=_n('view')
_rz(z,t5D,'class',57,e,s,gg)
var e6D=_oz(z,58,e,s,gg)
_(t5D,e6D)
_(fQC,t5D)
var cRC=_v()
_(fQC,cRC)
if(_oz(z,59,e,s,gg)){cRC.wxVkey=1
var b7D=_n('view')
_rz(z,b7D,'class',60,e,s,gg)
var o8D=_n('view')
...
var cEE=_n('view')
_rz(z,cEE,'class',66,cBE,fAE,gg)
var oFE=_mz(z,'post-list-card',['bind:__l',67,'class',1,'isMine',2,'post',3,'vueId',4],[],cBE,fAE,gg)
_(cEE,oFE)
_(hCE,cEE)
return hCE
}
x9D.wxXCkey=4
_2z(z,64,o0D,e,s,gg,x9D,'post','index','index')
_(b7D,o8D)
var lGE=_mz(z,'uni-load-more',['bind:__l',72,'class',1,'vueId',2],[],e,s,gg)
_(b7D,lGE)
_(cRC,b7D)
}
var aHE=_n('view')
_rz(z,aHE,'class',75,e,s,gg)
var tIE=_mz(z,'uni-popup',['bind:__l',76,'class',1,'custom',2,'data-ref',3,'type',4,'vueId',5,'vueSlots',6],[],e,s,gg)
var eJE=_mz(z,'button',['bindtap',83,'class',1,'data-event-opts',2,'type',3],[],e,s,gg)
var bKE=_oz(z,87,e,s,gg)
_(eJE,bKE)
_(tIE,eJE)
_(aHE,tIE)
_(fQC,aHE)
