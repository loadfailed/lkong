...
var x=['./pages/index/index.wxml','./pages/login/login.wxml','./pages/mine/mine.wxml','./pages/write/write.wxml'];d_[x[0]]={}
...
_(oP,xQ)
_(bO,oP)
var oR=_mz(z,'input',['focus',-1,'bindinput',12,'class',1,'data-event-opts',2,'placeholder',3,'value',4],[],e,s,gg)
_(bO,oR)
_(eN,bO)
var fS=_n('view')
...
_(cT,hU)
_(fS,cT)
var oV=_mz(z,'input',['password',-1,'bindinput',20,'class',1,'data-event-opts',2,'placeholder',3,'value',4],[],e,s,gg)
_(fS,oV)
_(eN,fS)
var cW=_n('view')
_rz(z,cW,'class',25,e,s,gg)
var oX=_mz(z,'button',['bindtap',26,'class',1,'data-event-opts',2],[],e,s,gg)
